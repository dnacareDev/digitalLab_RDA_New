...
public abstract class BlockPadding {
	...
	/**
	 * To provide byte padding to create an instance. Byte padding to provide that
	 * kind of 'ANSI X.923', 'ISO 10126', 'PKCS7' is.
	 * 
	 * @param type The type of padding bytes (ANSI X.923 : ANSIX923, ISO 10126 :
