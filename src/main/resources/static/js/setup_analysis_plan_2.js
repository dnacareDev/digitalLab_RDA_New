document.addEventListener('DOMContentLoaded', () => {
    ...
    if (result) {
		...
		// schedule 배열이 비어있을 경우 = 담당자(정), 담당자(부)가 없는경우
		// 해당과제의 연구책임자를 불러와서 schedule배열에 담당자(정)으로 끼워넣는다
		// DB에는 없지만 있는것처럼 꾸밈
		if(!result.schedule.length || result.schedule[0]?.managerList[0].account == null) {
			
			console.log(result.plan.prj_dtl_no);
			
			$.ajax({
	            url: '/main_manager_name',
	            method:"POST",
	            async: false, 
	            data : {
	                "prj_dtl_no" : result.plan.prj_dtl_no
	            },
	            success:function(name){
					//과제 책임자의 이름을 가져와야 한다. 그걸 name으로 사용
					//console.log("name : ", name);
					
					//user_name빼고 전부 script가 동작하기위해 넣은 임의의 fake-data(mgr_type은 1로 고정)
					//문제 발생시 조금 복잡하더라도 데이터를 전부 채워넣어야 함
					if(!result.schedule.length) {
						result.schedule.push({'managerList': [{'account' : result.plan.account,'mgr_type' : 1, 'sch_id':0, schedule_manager_id:0, 'user_name' : name, }] });	
					} else {
						result.schedule[0].managerList[0].account = result.plan.account;
						result.schedule[0].managerList[0].mgr_type = 1;
						result.schedule[0].managerList[0].user_name = name;
					}
    ...
    function getScheduleData(list = []){
        ...
        for(var i = 0 ; i < list.length ; i++){
            ...
            //console.log("td_2.innerText : ", td_2.innerText)
    ...
    function renderSecBatchTable(){      
		...
		if(plate_check){
	        tables[currentIndex].querySelectorAll('tbody tr').forEach((tr, rowIndex) => {
	            ...
	            console.log(optionTr);			// 작목
	            console.log(wellNoChar);		// A,B,C
	            console.log(wellNoNum);			// 몇번째 줄? (결국 A,B,C와 연결)
	            console.log(secRowIndex);		// 몇번째 열?
	            */
        ...
        handleBatchTrClick() 
        //dragula_js() // 96개의 data-index마다 영역을 잡아서 drag&drop
    }
    ...
    function setStepManagers(list) {
        ...
        list.forEach((manager) => {
			...
			//담당자(정)에 연구원만 나타나도록 처리
			//console.log("usertype : ", manager?.userType);
			//console.log("연구? : ", manager?.title);
			
			
			if( !(manager.userType == "계약직" && manager.title.includes('연구')) ) {
				//console.log("계약직 : ", manager.name);
				//console.log("담당자(정) : ", manager?.name);
				const tr = `
    ...
    function dragula_js() {
		...
		let dragg = dragula(
				[
					...
					document.querySelector('[data-index="3"]'),
					document.querySelector('[data-index="4"]'),
					document.querySelector('[data-index="5"]'),
					document.querySelector('[data-index="6"]'),
					document.querySelector('[data-index="7"]'),
					document.querySelector('[data-index="8"]'),
					document.querySelector('[data-index="9"]'),
					document.querySelector('[data-index="10"]'),
					document.querySelector('[data-index="11"]'),
					document.querySelector('[data-index="12"]'),
					document.querySelector('[data-index="13"]'),
					document.querySelector('[data-index="14"]'),
					document.querySelector('[data-index="15"]'),
					document.querySelector('[data-index="16"]'),
					document.querySelector('[data-index="17"]'),
					document.querySelector('[data-index="18"]'),
					document.querySelector('[data-index="19"]'),
					document.querySelector('[data-index="20"]'),
					document.querySelector('[data-index="21"]'),
					document.querySelector('[data-index="22"]'),
					document.querySelector('[data-index="23"]'),
					document.querySelector('[data-index="24"]'),
					document.querySelector('[data-index="25"]'),
					document.querySelector('[data-index="26"]'),
					document.querySelector('[data-index="27"]'),
					document.querySelector('[data-index="28"]'),
					document.querySelector('[data-index="29"]'),
					document.querySelector('[data-index="30"]'),
					document.querySelector('[data-index="31"]'),
					document.querySelector('[data-index="32"]'),
					document.querySelector('[data-index="33"]'),
					document.querySelector('[data-index="34"]'),
					document.querySelector('[data-index="35"]'),
					document.querySelector('[data-index="36"]'),
					document.querySelector('[data-index="37"]'),
					document.querySelector('[data-index="38"]'),
					document.querySelector('[data-index="39"]'),
					document.querySelector('[data-index="40"]'),
					document.querySelector('[data-index="41"]'),
					document.querySelector('[data-index="42"]'),
					document.querySelector('[data-index="43"]'),
					document.querySelector('[data-index="44"]'),
					document.querySelector('[data-index="45"]'),
					document.querySelector('[data-index="46"]'),
					document.querySelector('[data-index="47"]'),
					document.querySelector('[data-index="48"]'),
					document.querySelector('[data-index="49"]'),
					document.querySelector('[data-index="50"]'),
					document.querySelector('[data-index="51"]'),
					document.querySelector('[data-index="52"]'),
					document.querySelector('[data-index="53"]'),
					document.querySelector('[data-index="54"]'),
					document.querySelector('[data-index="55"]'),
					document.querySelector('[data-index="56"]'),
					document.querySelector('[data-index="57"]'),
					document.querySelector('[data-index="58"]'),
					document.querySelector('[data-index="59"]'),
					document.querySelector('[data-index="60"]'),
					document.querySelector('[data-index="61"]'),
					document.querySelector('[data-index="62"]'),
					document.querySelector('[data-index="63"]'),
					document.querySelector('[data-index="64"]'),
					document.querySelector('[data-index="65"]'),
					document.querySelector('[data-index="66"]'),
					document.querySelector('[data-index="67"]'),
					document.querySelector('[data-index="68"]'),
					document.querySelector('[data-index="69"]'),
					document.querySelector('[data-index="70"]'),
					document.querySelector('[data-index="71"]'),
					document.querySelector('[data-index="72"]'),
					document.querySelector('[data-index="73"]'),
					document.querySelector('[data-index="74"]'),
					document.querySelector('[data-index="75"]'),
					document.querySelector('[data-index="76"]'),
					document.querySelector('[data-index="77"]'),
					document.querySelector('[data-index="78"]'),
					document.querySelector('[data-index="79"]'),
					document.querySelector('[data-index="80"]'),
					document.querySelector('[data-index="81"]'),
					document.querySelector('[data-index="82"]'),
					document.querySelector('[data-index="83"]'),
					document.querySelector('[data-index="84"]'),
					document.querySelector('[data-index="85"]'),
					document.querySelector('[data-index="86"]'),
					document.querySelector('[data-index="87"]'),
					document.querySelector('[data-index="88"]'),
					document.querySelector('[data-index="89"]'),
					document.querySelector('[data-index="90"]'),
					document.querySelector('[data-index="91"]'),
					document.querySelector('[data-index="92"]'),
					document.querySelector('[data-index="93"]'),
					document.querySelector('[data-index="94"]'),
					document.querySelector('[data-index="95"]'),
				]
		);
